...
var $mail:=cs.agtools.AIToolMail.new( \
...
var $search:=cs.agtools.AIToolSearch.new({maxResults: 5})
var $webFetch:=cs.agtools.AIToolWebFetch.new({allowedDomains: ["*.wikipedia.org"]})
